...
<?php if ($contact->id->Visible) { // id ?>
		<th><span id="elh_contact_id" class="contact_id"><?php echo $contact->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($contact->name->Visible) { // name ?>
		<th><span id="elh_contact_name" class="contact_name"><?php echo $contact->name->FldCaption() ?></span></th>
<?php } ?>
<?php if ($contact->lastname->Visible) { // lastname ?>
		<th><span id="elh_contact_lastname" class="contact_lastname"><?php echo $contact->lastname->FldCaption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($contact->lastname->Visible) { // lastname ?>
		<td<?php echo $contact->lastname->CellAttributes() ?>>
<span id="el<?php echo $contact_delete->RowCnt ?>_contact_lastname" class="contact_lastname">
...
<?php } ?>
<?php if ($contact->status->Visible) { // status ?>
		<td<?php echo $contact->status->CellAttributes() ?>>
