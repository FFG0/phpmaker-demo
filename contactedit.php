...
class ccontact_edit extends ccontact {
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", $this->TableVar, "contactlist.php", "", $this->TableVar, TRUE);
		$PageId = "edit";
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $contact->name->FldCaption(), $contact->name->ReqErrMsg)) ?>");
			elm = this.GetElements("x" + infix + "_lastname");
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $contact->lastname->FldCaption(), $contact->lastname->ReqErrMsg)) ?>");
...
?>
<form name="fcontactedit" id="fcontactedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($contact->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_contact_id" class="col-sm-2 control-label ewLabel"><?php echo $contact->id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $contact->id->CellAttributes() ?>>
...
<input type="hidden" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($contact->id->CurrentValue) ?>">
<?php echo $contact->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($contact->name->Visible) { // name ?>
	<div id="r_name" class="form-group">
		<label id="elh_contact_name" for="x_name" class="col-sm-2 control-label ewLabel"><?php echo $contact->name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $contact->name->CellAttributes() ?>>
<span id="el_contact_name">
<input type="text" data-field="x_name" name="x_name" id="x_name" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($contact->name->PlaceHolder) ?>" value="<?php echo $contact->name->EditValue ?>"<?php echo $contact->name->EditAttributes() ?>>
</span>
...
<?php if ($contact->lastname->Visible) { // lastname ?>
	<div id="r_lastname" class="form-group">
		<label id="elh_contact_lastname" for="x_lastname" class="col-sm-2 control-label ewLabel"><?php echo $contact->lastname->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $contact->lastname->CellAttributes() ?>>
<span id="el_contact_lastname">
<input type="text" data-field="x_lastname" name="x_lastname" id="x_lastname" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($contact->lastname->PlaceHolder) ?>" value="<?php echo $contact->lastname->EditValue ?>"<?php echo $contact->lastname->EditAttributes() ?>>
</span>
<?php echo $contact->lastname->CustomMsg ?></div></div>
	</div>
<?php } ?>
